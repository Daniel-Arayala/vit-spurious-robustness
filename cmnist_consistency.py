...
def calculate_consistency(args):
    ...
    testloader = get_biased_mnist_dataloader(root='~/Documents/CMNIST/datasets/MNIST', transform=transform,
                                             batch_size=args.batch_size,
                                             data_label_correlation=0.45,
                                             n_confusing_labels=1,
                                             train=False, partial=True, cmap="1", orig=False, fg_color=FG_COLOR,
                                             bg_color=BG_COLOR)
