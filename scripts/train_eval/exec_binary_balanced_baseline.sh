...
# ViT Evaluation
python evaluate.py --name balanced_binary_no_repos_full_eyepacs --model_arch ViT --model_type ViT-S_16 --metadata_file_name metadata_binary_balanced_baseline --dataset eyepacs --dataset_folder_name eyepacs --metric_types bin --num_workers 6 --img_size 256 --batch_size 128 --num_classes 2 --save_prediction_info --use_clearml
